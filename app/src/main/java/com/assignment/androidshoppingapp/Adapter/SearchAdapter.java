...
import com.assignment.androidshoppingapp.Activity .DetailActivity;
import com.assignment.androidshoppingapp.Domain.ItemsModel;
import com.assignment.androidshoppingapp.databinding.ViewholderSearchBinding;
...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.Viewholder> {
    ...
    public SearchAdapter(ArrayList<ItemsModel> items) {
        this.items = items;
    }
